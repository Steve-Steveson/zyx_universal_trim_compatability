...
public record TrimmedItemModel(@Nullable ArmorTrim trim) implements IUnbakedGeometry<TrimmedItemModel>
{
    ...
    public BakedModel bake(IGeometryBakingContext context, ModelBaker baker, Function<Material, TextureAtlasSprite> spriteGetter, ModelState modelState, ItemOverrides overrides, ResourceLocation modelLocation)
    {
        ...
        addQuads(modelState, modelLocation, baseSprite, builder, normalRenderTypes, FLUID_TRANSFORM);
        ...
        if (trimSprite != null)
        {
            addQuads(modelState, modelLocation, trimSprite, builder, normalRenderTypes, COVER_TRANSFORM);
        }
